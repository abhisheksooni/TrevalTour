...
const handleSubmit  = async (e)=>{
    e.preventDefault();
    const res = await fetch("https://treval-backend.onrender.com/shinup",{
        method:'POST',
...
// },[user])
  ...
  return (
   <>
    <div   className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 lg:h-[80vh]">
  ...
  <form onSubmit={handleSubmit}className='  flex flex-col gap-2'>
        ...
        <button type='submit' className='rounded-full p-4 bg-color5 text-white w-full max-w-[250px] mx-auto'>Create Admin</button>
      </form>
