...
function ListTourCard({NavLinkUrl, image,tourName,price,reting,mapLoction,days}) {
  return (
    <NavLink to={NavLinkUrl} className={`sm:w-[45%] lg:max-w-[435px] min-w-[330px] sm:min-w-[350px] w-full`} >
      
    <div className="  rounded-3xl transition-all duration-100 hover:scale-[0.98] cursor-pointer w-full">
    ...
    <img className='rounded-3xl sm:h-[315px] w-full h-full' src={image?image:"https://images.unsplash.com/photo-1717781617540-9f31ba241a4e?q=80&w=2129&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"} alt="" />
        </div>
