...
function ListTourCard({NavLinkUrl, image,tourName,price,reting,mapLoction}) {
  return (
    <NavLink to={NavLinkUrl?NavLinkUrl:"/detailtour"} className={`sm:w-[45%] lg:max-w-[435px] min-w-[330px] sm:min-w-[350px] w-full`} >
      
    <div className="  rounded-3xl transition-all duration-100 hover:scale-[0.98] cursor-pointer">
